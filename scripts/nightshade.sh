...
# application vars
core_pkgs=("git" "vim" "gpa" "obs-studio" "filezilla" "fish" "cmus" "htop" "gnome-weather" "gnome-todo" "mpv" "neofetch" "chromium" "firefox" "torbrowser-launcher" "rhythmbox" "telegram-desktop" "cowsay" "wireshark" "ufw" "gufw" "virtualbox-qt") # TODO: Add other packages to core_pkgs? 
# .deb games, Steam
